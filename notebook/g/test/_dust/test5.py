...
pygame.display.set_caption("PG GUI Test Display")
...
class TitleScene:
    def __init__(self):
        ...
        self.title_label.set_position((SCREEN_WIDTH // 2, SCREEN_HEIGHT // 4))
        ...
        self.start_button.set_position((SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2))
...
class InputScene:
    def __init__(self):
        ...
        self.input_label.set_position((SCREEN_WIDTH // 2, SCREEN_HEIGHT // 4))
        ...
        self.input_box.set_position((SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2))
        ...
        self.ok_button.set_position((SCREEN_WIDTH // 2, SCREEN_HEIGHT * 3 // 4))
